...
A simple and responsive **Income & Expense Tracker** web app built using **HTML, CSS, and JavaScript**.  
It helps you **add, view, and reset your income and expense entries** — with live balance updates and clean, mobile-friendly design.
